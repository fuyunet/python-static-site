...
class TestMarkdwonToHTML(unittest.TestCase):
    def test_markdwon_to_blocks(self):
        md = """
...
"""
        ...
        self.assertEqual(
            html,
            "<div><p>This is <b>bolded</b> "
            + "paragraph text in a p tag here</p></div>",
        )
...
"""
        ...
        self.assertEqual(
            ...
            + "<li>and <i>more</i> items</li></ul>"
            + "<ol><li>This is an <code>ordered</code> list</li>"
